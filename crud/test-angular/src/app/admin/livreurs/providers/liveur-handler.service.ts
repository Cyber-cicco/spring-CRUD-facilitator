...
export class LivreurHandlerService extends UtilisateurService implements BaseHandler<Utilisateur, UtilisateurPresentation>{

  constructor(http:HttpClient, private mapper:UtilisateurMapperService, private crud:UtilisateurDataflowService) {
    super(http)
  }
